...
/** Port definitions **/
// MAX7219
int ledMatrixCLK = P1_4;       // MAX7219 clock port
int ledMatrixCS = P1_5;        // MAX7219 load port
int ledMatrixDIN = P1_3;      // MAX7219 Data In port
...
void setup() {
    ...
    TA0CCR0=2065951; // Set TACCR0 = 2000 to generate a 1s timebase @ 16MHz with a divisor of 8
